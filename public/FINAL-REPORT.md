...
![Концепт редизайна: Карточный режим турниров](./practice-images/redesign-1-tournaments.png)

*Рисунок 1. Концепт карточного режима турниров с унифицированным визуальным языком*
...
- Добавить текстовые подписи под иконками: "Previous", "Next", "Flip Board", "Settings"
- При hover показывать сокращенный вид с иконками

**2.2. Переключатель языка в шапке**
- Вынести выбор языка из Settings прямо в шапку сайта
- Использовать иконку глобуса с кодом языка (EN/RU/DE)
...
![Концепт редизайна: Улучшение доступности](./practice-images/redesign-2-accessibility.png)

*Рисунок 2. Концепт улучшения доступности: видимые подписи к иконкам и язык в шапке*
...
- При загрузке Learn для гостя проверить `localStorage['lichess_learn_progress']`
- Если есть — показать сохранённый прогресс
- При регистрации — предложить "Перенести прогресс в аккаунт"
- При выходе — показать warning "Ваш прогресс не будет сохранён без регистрации"

**3.2. Структурирование Studies**
- Разделить на вкладки: "Официальные" и "Сообщество"
- Добавить фильтр по уровню: Новичок / Средний / Продвинутый
- Добавить рейтинг пользовательского контента

**3.3. Виджет "Продолжить обучение" на главной**
- Карточка с прогресс-баром текущего курса
- Кнопки "Продолжить" и "Все уроки"
- Показывать пройденные и оставшиеся темы

**3.4. Явный индикатор сохранения**
- Для гостя: красный баннер "Прогресс не сохраняется. [Создать аккаунт]"
- Для пользователя: зелёная галочка "Прогресс сохранён"

#### Макет:

![Концепт редизайна: Поддержка обучения](./practice-images/redesign-3-learning.png)

*Рисунок 3. Концепт улучшения поддержки обучения: сохранение прогресса, структурирование Studies, виджет продолжения*
...
2. **Улучшение доступности** — видимые подписи к иконкам, язык в шапке, увел��ченные целевые области
